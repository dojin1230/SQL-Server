...
SELECT 
	...
	CASE
		WHEN List_EN.[Campaign_Data_33] LIKE '%kemoji%' THEN List_EN.[Campaign_Data_33] --kemoji
...
SELECT *, 
	CASE
		...
		WHEN #001.[data1] LIKE '%kemoji%' THEN N'카카오-E' -- kemoji
...
SELECT 
	...
	#001_1.[korean_name], 
	#001_1.[phone_number], 
	dbo.udf_GetNumeric(#001_1.[phone_number]) AS phone_number_1,
	#001_1.[campaign_id], 
	#001_1.[campaign_date], 
...
SELECT 
	...
	#002.[phone_number_1],
	CASE
		WHEN LEFT(#002.[phone_number_1],2)='82' AND LEN(#002.[phone_number_1]) > 9 THEN SUBSTRING(#002.[phone_number_1],3,20)
		WHEN LEFT(#002.[phone_number_1],4)='0082' THEN SUBSTRING(#002.[phone_number_1],5,20)
		WHEN LEFT(#002.[phone_number_1],4)='0010' AND LEN(#002.[phone_number_1]) = 12 THEN SUBSTRING(#002.[phone_number_1],2,20)
...
SELECT 
	...
	CASE
		WHEN SUBSTRING(#004.[phone_number_3],1,4) = 'comp' AND SUBSTRING(#004.[phone_number_3],9,1) not in (0,1) THEN 'T'
		ELSE 'F'
	END AS modified_tf,
	#004.[campaign_id], 
...
INSERT INTO [work].[dbo].[lead_gen_count] (DATE, r5, r4, r3, r2, r1, c1, c2, c3, c4, c5, c6, c7) 
