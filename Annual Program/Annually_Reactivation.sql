...
ON
	D.회원번호 = NR.회원번호
WHERE
	--D.최종납부년월 < '2016-12'					-- Monthly Reactivation 콜이랑 안 겹치도록, 최종납부년월이 2016년 12월 이전인 사람만
	D.최종납부년월 < SUBSTRING(CONVERT(varchar(10), DATEADD(month, -13, GETDATE()), 126), 1, 7) -- Monthly Reactivation 콜이랑 안 겹치도록, 최근에 lapsed donor가 된 사람 제외
